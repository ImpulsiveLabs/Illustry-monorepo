...
const visualizationDataSchema = z.object({
    ...
    accessType: z.union([z.literal('direct'), z.literal('inherited')]).optional(),
    sourceType: z.union([z.literal('dashboard'), z.literal('visualization')]).optional(),
    sourceDashboardId: stringSchema.optional(),
    ...
    sharedWith: z.array(z.object({
        ...
        sharedViaResource: z.union([z.literal('visualization'), z.literal('dashboard')]).optional(),
        sharedViaShareId: stringSchema.optional(),
...
const dashboardDataSchema = z.object({
    ...
    sharedWith: z.array(z.object({
        ...
        permission: z.union([z.literal('viewer'), z.literal('editor')]),
        status: z.union([z.literal('pending'), z.literal('accepted'), z.literal('rejected')]).optional(),
        sharedViaResource: z.literal('dashboard').optional(),
        sharedViaShareId: stringSchema.optional(),
        inviteToken: stringSchema.optional(),
        inviteExpiresAt: dateSchema.optional(),
        respondedAt: dateSchema.optional(),
